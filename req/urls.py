...
urlpatterns = [
    # View与APIView的区别
    path("student1/", views.Student1View.as_view()),  # View
    path("student2/", views.Student2APIView.as_view()),  # APIView
    ...
    # 视图集
    path("student7/", views.Student11GenericViewSet.as_view({"get": "list", "post": "create"})),
    re_path(r"^student7/(?P<pk>\d+)/$", views.Student11GenericViewSet.as_view({"get": "retrieve", "put": "update", "delete": "destroy"})),
]
